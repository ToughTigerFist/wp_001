...
function elegant_blocks_get_google_fonts(){

    $curlSession = curl_init();
    curl_setopt($curlSession, CURLOPT_URL, plugins_url( '/src/inc/google-fonts.json', dirname( __FILE__ ) ) );
...
function elegant_blocks_backend_css_js() {
    ...
    $translation_array = array(
        ...
        'google_fonts' => json_decode( elegant_blocks_get_google_fonts() ),
